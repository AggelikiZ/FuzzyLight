...
def parse_args():
    ...
    parser.add_argument("-memo",       type=str,           default='benchmark_directlight')
    parser.add_argument("-mod",        type=str,           default="DirectLight")
    parser.add_argument("-gen",        type=int,            default=1)
    parser.add_argument("-multi_process", action="store_true", default=True)
    parser.add_argument("-workers",    type=int,            default=1)

    parser.add_argument("-segments",    type=int,           default=8)
    parser.add_argument("-fuzzy_value", type=float,         default=1.0) # default: int(24/24.0)
...
def main(in_args=None):
    ...
    NUM_SEGMENTS = in_args.segments
    FUZZY_VAL = in_args.fuzzy_value
