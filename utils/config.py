...
#from models.fuzzy_light_cycle import FuzzyLightCycle
from models.fuzzy_light import FuzzyLight
from models.fuzzy_light_with_no_attention import FuzzyLight1

DIC_AGENTS = {
    #"FuzzyLightCycle" :FuzzyLightCycle,
    "FuzzyLight": FuzzyLight,
    "FuzzyLight1": FuzzyLight1,
}
